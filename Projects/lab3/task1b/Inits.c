 ...
 * 1965514 
 * 11/17/2022
 * This is the file containing all initialization functions for Lab 3 task 1 part b with the provided PLL initialization.
 * This file is very similar to the Inits function from part a however it uses on-board switches instead of LEDs.
 */
